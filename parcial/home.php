...
<div class="contenedor">
    <div class="home" id="home">
        <div class="text">
            ...
            <h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi laboriosam enim dicta expedita dolorum
                neque dolores delectus esse excepturi eligendi quo quia veniam nostrum facere perspiciatis magnam, odio
                tenetur! Distinctio?</h3>
        </div>
        <div class="imgBx">
            <img src="https://i.postimg.cc/TY9rjqrf/dog.jpg" alt="">
        </div>
    </div>
    <div class="ingresar" id="ingresar">
        <div class="imgBx">
            <img src="https://i.postimg.cc/g2qpMjgV/dog2.jpg" alt="">
        </div>
        <div class="formBx">
            <div class="form signinForm">
                <form action="login.php" method="POST">
                    ...
                    <?php unset($_SESSION['error_login']);
                        unset($_SESSION['error_login_class']);
                    endif; ?>
            ...
            <div class="form signupForm">
                <form action="register.php" method="POST">
                    ...
                    <?php unset($_SESSION['error_dni_user']);
                        unset($_SESSION['error_dni_class']);
                    endif; ?>
                    <input type="password" name="password" placeholder="Contraseña">
                    <!-- Agregado -->
                    ...
                    <?php unset($_SESSION['error_register_user']);
                        unset($_SESSION['error_register_class']);
                    endif; ?>
